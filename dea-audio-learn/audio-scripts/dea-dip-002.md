...
ここで重要になるのが[Delta Lake](#delta-lake)です。Delta Lakeは、Lakehouse上のデータを**信頼できるテーブル**として管理するための技術です。たとえば、複数の処理が同じテーブルに関わるときでも一貫性を保つ[ACIDトランザクション](#acid-transaction)、想定外の列や型の変化を扱うスキーマ管理、過去の状態を追いやすくする履歴管理などを提供します。
